...
namespace GovUk.Frontend.AspNetCore.TagHelpers
{
    ...
    public class TabsTagHelper : TagHelper
    {
        ...
        /// <summary>
        /// The <c>id</c> attribute for the tabs component.
        /// </summary>
        [HtmlAttributeName(IdAttributeName)]
        public string? Id { get; set; }

        /// <summary>
        /// The prefix to use when generating the <c>id</c> attribute for each item.
        /// </summary>
        /// <remarks>
        /// This is only used when an item does not have its own <c>id</c> specified.
        /// </remarks>
